							...
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
								...
								<div className="space-y-1 min-w-0">
									...
									<div
										...
										onMouseEnter={handleLinkerEnter}
										onMouseLeave={handleLinkerLeave}
									>
										...
										{showLinkerPreview && (
											<div className="absolute left-0 top-full z-30 mt-3 w-80 max-w-[calc(100vw-4rem)] rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-2xl">
								...
								<div className="relative z-10 space-y-6">
									...
									<div className="bg-indigo-100/50 dark:bg-indigo-900/30 p-3 rounded-lg border border-indigo-200 dark:border-indigo-800/50 mt-2">
										<p className="text-xs text-indigo-800 dark:text-indigo-200 italic">
											"AI Model v2.1 predicts this framework fits the standard {mof.topology_code} topology
											template with high fidelity. Suggested for catalytic applications."
										</p>
									</div>
								</div>
							</div>
